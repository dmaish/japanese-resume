...
export const BackgroundDecoration = () => {
  return <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-1/4 left-0 h-96 w-4 bg-red-800 opacity-10 transform -rotate-12"></div>
      {/* Horizontal brush stroke */}
      <div className="absolute top-3/4 right-0 h-4 w-64 bg-indigo-900 opacity-10 transform rotate-6"></div>
    </div>;
};