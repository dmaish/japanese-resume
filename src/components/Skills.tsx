...
export const Skills = () => {
  const skills = [{
    ...
    items: ['React', 'Tailwind CSS', 'Nestjs', 'NodeJS','Responsive Design']
  }, {
    category: 'Languages',
    icon: <GlobeIcon size={24} className="text-red-700" />,
    items: ['HTML/CSS', 'JavaScript', 'Typescript', 'English (Fluent)']
  }, {
    category: 'Other Skills',
    icon: <LayersIcon size={24} className="text-red-700" />,
    items: ['Git & Version Control', 'UI/UX Design', 'Figma','Color Theory']
  }];
